# Move font Options to Unluminate -> Settings -> Appearance -> Font
...
I should be able to have multiple instances of Unluminate open, each with their own project opened, similar to Intellij.
...
This needs extensive online research, and extensive testing, and a separate tasks unluminate-terminal-tdd.md technical design document.
...
# Unluminate label
That belongs at the very left of the top bar, so its Unluminate, File
# Code Layout
