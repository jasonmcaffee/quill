# Move font Options to Unluminous -> Settings -> Appearance -> Font
...
I should be able to have multiple instances of Unluminous open, each with their own project opened, similar to Intellij.
...
This needs extensive online research, and extensive testing, and a separate tasks unluminous-terminal-tdd.md technical design document.
...
# Unluminous label
That belongs at the very left of the top bar, so its Unluminous, File
# Code Layout
