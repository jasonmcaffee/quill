//! The terminal behind Unluminate's bottom tile.
//!
//! This crate has no user interface dependencies, for the same reason `unluminate-core` has none: its tests run
...
//!
//! What is here and what is not is set out in `tasks/unluminate-terminal-tdd.md`. In short: the escape sequence
