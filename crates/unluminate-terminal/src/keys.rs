...
//!
//! This is the table in section 9 of `tasks/unluminate-terminal-tdd.md`, and the sequences are the ones xterm
//! defines and every terminal follows. It is written here rather than taken from a crate because it is the
//! part most likely to need changing for Unluminate, and because a table of expected bytes is the easiest thing
