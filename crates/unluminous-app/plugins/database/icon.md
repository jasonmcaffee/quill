...
```bash
cargo run --example plugin_icon -- _agent_output/task-1795-icons/database-source.png crates/unluminous-app/plugins/database
```
...
```bash
cargo run --example scale -- crates/unluminous-app/plugins/database/icon.png /tmp/icon-large.png 8
```
