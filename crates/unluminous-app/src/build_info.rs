//! What this build of Unluminous is: its version, and when it was built.
//!
...
//! `unluminous-cli status` and anything written later cannot come to different answers about what is
//! running.
//!
...
/// Who wrote it. On the About box, and in `unluminous.exe`'s version block, where `build.rs` puts it.
