...
//!
//! Quill already has everything needed to show formatted text: a styled text model, a layout engine
...
//! Quill has no HTML, no box model and no inline layout. Everything a crate gave back would have to
