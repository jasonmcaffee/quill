...
//! because text in Quill is always fully opaque; and it is inherited by whatever is typed next,
...
impl Highlights {
    ...
    ///
    /// What a file that changed on the disk underneath Quill needs: the offsets were written against
