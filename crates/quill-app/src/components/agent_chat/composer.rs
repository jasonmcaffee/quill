...
//! Quill's rule about a control that cannot apply being absent rather than present and refusing.
//!
...
//! can: its own server knows the window the model was loaded with. Quill does not — a URL and a model
