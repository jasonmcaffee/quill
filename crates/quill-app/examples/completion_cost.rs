...
//!
//! `cargo run --release -p quill-app --example completion_cost -- [folder] [stem]`
//!
//! It drives a **real window** — the same `QuillApp` the application is, with the project's index
...
use quill_app::app::QuillApp;
use quill_app::services::file_tree::FileTree;
use quill_app::services::plugins::Plugins;
use quill_core::symbols::FileSymbols;
