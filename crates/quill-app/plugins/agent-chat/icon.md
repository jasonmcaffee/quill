...
```bash
cargo run --example plugin_icon -- _agent_output/task-1795-icons/agent-chat-source.png crates/quill-app/plugins/agent-chat
```
...
```bash
cargo run --example scale -- crates/quill-app/plugins/agent-chat/icon.png /tmp/icon-large.png 8
```
