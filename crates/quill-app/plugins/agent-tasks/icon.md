...
```bash
cargo run --example plugin_icon -- _agent_output/task-1795-icons/agent-tasks-source.png crates/quill-app/plugins/agent-tasks
```
...
```bash
cargo run --example scale -- crates/quill-app/plugins/agent-tasks/icon.png /tmp/icon-large.png 8
```
