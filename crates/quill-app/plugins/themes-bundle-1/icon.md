...
```bash
cargo run --example plugin_icon -- _agent_output/task-1795-icons/themes-bundle-1-source.png crates/quill-app/plugins/themes-bundle-1
```
...
```bash
cargo run --example scale -- crates/quill-app/plugins/themes-bundle-1/icon.png /tmp/icon-large.png 8
```
