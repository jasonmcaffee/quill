...
pub struct Message {
    ...
    /// The server's own words, when the request failed. Never invented — see `quill-git`'s rule.
...
impl Message {
    ...
    /// assistant message holding only Quill's own note about why — and sent back as
