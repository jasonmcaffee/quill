...
/// of a keystroke when this was measured on Unluminate's own biggest file. Kept and cleared instead: the
...
/// three separators the languages Unluminate reads actually use — and a lower-to-upper camel step. Not
