...
//!
//! §11 of `tasks/unluminate-mermaid-plugin-tdd.md` asks that the same four things be true of every
//! diagram Unluminate draws, and that a diagram type added later inherit the list rather than have to
