...
/// that Unluminate cannot draw and drops.
...
///
/// Unluminate has no HTML engine and will not grow one, so a tag is not shown. Four of them have an
...
mod tests {
    ...
    #[test]
    fn a_tag_unluminate_cannot_draw_is_not_shown() {
