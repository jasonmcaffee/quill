...
//!
//! A table needs columns of equal width, and Unluminate's layout engine places one glyph after another
...
//! this. And it is what Unluminate already does one step down — the horizontal rule has been forty-eight
