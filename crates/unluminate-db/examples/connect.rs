...
//!
//! ```text
//! cargo run -p unluminate-db --example connect -- "postgres://postgres@localhost:5432/ai" PGPASSWORD
//! cargo run -p unluminate-db --example connect -- C:\jason\dev\unluminate\tasks.db
//! ```
//!
...
use unluminate_db::{Database, Kind};
