...
///
/// Hooks run, because a hook is something the repository's owner asked for and a commit from Quill
...
mod tests {
    ...
    fn a_clone_lands_in_a_folder_named_after_the_repository() {
        assert_eq!(clone_folder_name("https://github.com/jasonmcaffee/quill.git"), "quill");
        assert_eq!(clone_folder_name("https://github.com/jasonmcaffee/quill"), "quill");
        assert_eq!(clone_folder_name("git@github.com:jasonmcaffee/quill.git"), "quill");
