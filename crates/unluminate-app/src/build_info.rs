//! What this build of Unluminate is: its version, and when it was built.
//!
...
//! `unluminate-cli status` and anything written later cannot come to different answers about what is
//! running.
//!
...
/// Who wrote it. On the About box, and in `unluminate.exe`'s version block, where `build.rs` puts it.
