...
//! this component **reports and decides nothing**, which is the rule every component in Unluminate follows.
//!
...
pub fn handle(ui: &mut egui::Ui, header: Rect, panel: Panel) -> Grab {
    ...
    // Named, because every control in Unluminate has a plain name and a test finds one by it.
