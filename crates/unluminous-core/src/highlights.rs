...
//! because text in Unluminous is always fully opaque; and it is inherited by whatever is typed next,
...
impl Highlights {
    ...
    ///
    /// What a file that changed on the disk underneath Unluminous needs: the offsets were written against
