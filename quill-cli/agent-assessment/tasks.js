...
// `check` runs a `quill-cli` command against the live window afterwards and tests the answer, so a
...
// The window as a fresh Quill on the sample project would be.
//
...
const tasks = [
  ...
  {
    id: 'what-is-running',
    say: 'Are there any Quill windows running, and on what?',
    expectCommand: 'instances',
  },
  {
    id: 'the-about-box',
    say: 'What version of the Quill editor am I running?',
  ...
  },
  {
    ...
    say: 'Make the Quill window exactly 1000 by 700.',
  ...
  },
  {
    ...
    say: 'Put the editor font size back to whatever a brand new Quill uses.',
