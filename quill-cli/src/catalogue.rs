...
pub fn area_title(area: &'static str) -> &'static str {
    match area {
        ...
        "plugins" => "plugins — the languages Quill colours, and the panes it draws",
...
pub const COMMANDS: &[Command] = &[
    ...
    Command {
        area: "plugins",
        verb: "list",
        summary: "The plugins Quill has, which of them are switched on, and what each one claims: a language it colours, or a pane, a tab, a menu and a Settings page it contributes. They ship with Quill; nothing is fetched.",
        arguments: NO_ARGUMENTS,
        flags: NO_FLAGS,
