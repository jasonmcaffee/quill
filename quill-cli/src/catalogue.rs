...
pub const COMMANDS: &[Command] = &[
    ...
    Command {
        area: "explorer",
        verb: "new-file",
        summary: "Make an empty file. The folders above it are made too, and it opens in a tab. The same thing New -> File on the explorer's right click menu does, without the dialog.",
    ...
    Command {
        area: "explorer",
        verb: "new-folder",
        summary: "Make a folder, and every folder above it. The same thing New -> Folder on the explorer's right click menu does, without the dialog.",
