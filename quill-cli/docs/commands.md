...
- `theme` — Its key, `themes-bundle-1/dracula`, or its name, `Monokai Pro`. The active one when it is left out.
...
- `theme` — Its key, `themes-bundle-1/dracula`, or its name, `Material Deep Ocean`.
