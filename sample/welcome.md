...
Everything you can see here is drawn by Unluminous itself: the text
...
- `File` then `New Window` opens a second Unluminous, and `Recent Projects` lists the folders you have had open.
...
it becomes the same styled text Unluminous already knows how to lay out, which is why
...
| -------------- | ------------------------------- | ----: |
| unluminous-core | the editor, with no window | 639 |
| unluminous-terminal | the pseudoterminal and a screen | 116 |
| unluminous-app | drawing, fonts, settings, menus | 796 |

## The files

Any file holding text opens, whether Unluminous knows the kind of file or not, so
