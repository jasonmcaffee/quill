//! Write the reference half of `unluminate-cli/docs/commands.md` from the catalogue.
//!
//! Run it with `cargo run -p unluminate-cli --example reference`.
//!
...
use unluminate_cli::catalogue::{self, Command};
