...
// `check` runs an `unluminous-cli` command against the live window afterwards and tests the answer, so a
...
// The window as a fresh Unluminous on the sample project would be.
//
...
const tasks = [
  ...
  {
    id: 'what-is-running',
    say: 'Are there any Unluminous windows running, and on what?',
    expectCommand: 'instances',
  },
  {
    id: 'the-about-box',
    say: 'What version of the Unluminous editor am I running?',
  ...
  },
  {
    ...
    say: 'Make the Unluminous window exactly 1000 by 700.',
  ...
  },
  {
    ...
    say: 'Put the editor font size back to whatever a brand new Unluminous uses.',
